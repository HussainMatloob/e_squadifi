...
class ProfileImproveGameScreen extends StatefulWidget {
  ...
  @override
  State<ProfileImproveGameScreen> createState() =>
      _ProfileImproveGameScreenState();
}
            ...
            children: [
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: ClipRRect(
                      child: Image.asset(
                        ImageConstants
                            .profileImagesList[profileController.selectedIndex],
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
                  Positioned(
                    ...
                    child: Row(
                      ...
                      children: [
                        for (int i = 0;
                            i < ImageConstants.profileImagesList.length;
                            i++)
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    border:
                        Border.all(width: 1, color: ColorConstant.borderColor)),
                child: Column(
                  children: [
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              for (int i = 0;
                                  i < ImageConstants.AchievementIcons.length;
                                  i++)
                                CustomImageContainer(
                                  height: 26.h,
                                  width: 55.w,
                                  borderRadius: 16.r,
                                  image: ImageConstants.AchievementIcons[i],
                                  onTap: () {},
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            ColumnWidget(
                              ...
                              text2: "Challenges",
                              gradientColor:
                                  ColorConstant.challengesGradientColor,
                              achievement: true,
                              color: ColorConstant.greyColor,
                              height: 40.h,
                              width: 60.w,
                            ...
                            ColumnWidget(
                              ...
                              text2: "Tournaments",
                              gradientColor:
                                  ColorConstant.tournamentGradientColor,
                              achievement: true,
                              color: ColorConstant.greyColor,
                              height: 40.h,
                              width: 60.w,
