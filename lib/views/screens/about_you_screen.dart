                              ...
                              children: [
                                Expanded(
                                  child: DropdownButtonFormField<String>(
                                    ...
                                    value:
                                        authenticationController.selectedYear,
                                    onChanged: (newValue) {
                                ...
                                Expanded(
                                  child: DropdownButtonFormField<String>(
                                    ...
                                    dropdownColor: ColorConstant.greyColor,
                                    value:
                                        authenticationController.selectedMonth,
                                    onChanged: (newValue) {
                                      authenticationController
                                  ...
                                  for (int i = 0;
                                    ...
                                    Padding(
                                      ...
                                      child: ButtonWidget(
                                        ...
                                        height: 48.h,
                                        color:
                                            authenticationController.gender ==
                                                    AppData.genderList[i]
                                        ...
                                        onTap: () {
                                          authenticationController.selectGender(
                                              AppData.genderList[i]);
                                        },
                                      ),
                                    ),
