...
class InviteSquadMemberScreen extends StatefulWidget {
  ...
  @override
  State<InviteSquadMemberScreen> createState() => _InviteSquadMemberScreenState();
}
                                ...
                                Row(
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        CustomText("Squad Name",fw: FontWeight.w700,size: 18.sp,color: ColorConstant.whiteColor,),
                                        CustomText("squad. 2 group",fw: FontWeight.w400,size: 14.sp,color: ColorConstant.whiteColor,)
                                      ],),
